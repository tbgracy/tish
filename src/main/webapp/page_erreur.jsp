...
<body>
	...
	<main class='container error-container'>
		<h4 id='error-title'>Oups ... Une erreur est survenue lors du traitement de votre
			requête.</h4>
			<p class='error-code'>Erreur <mark><%=response.getStatus()%></mark></mark></p>
			<img id='error-img' src='ressources/images/error_illu.png' width='400px'>
	</main>
